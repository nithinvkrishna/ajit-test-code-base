...
set genomeRtd $env(RT_TMP)/BDA71180.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {peripherals__GB0}]"
...
set genomeName [subst -nocommands -novariables {peripherals__GB0}]

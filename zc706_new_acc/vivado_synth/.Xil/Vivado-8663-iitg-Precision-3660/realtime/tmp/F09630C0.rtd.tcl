...
set genomeRtd $env(RT_TMP)/F09630C0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {teu_no_fp__GCB0}]"
...
set genomeName [subst -nocommands -novariables {teu_no_fp__GCB0}]

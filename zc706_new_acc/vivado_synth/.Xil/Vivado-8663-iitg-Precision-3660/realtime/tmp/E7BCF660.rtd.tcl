...
set genomeRtd $env(RT_TMP)/E7BCF660.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {core_1x32_no_fp_no_mmu__GC0}]"
...
set genomeName [subst -nocommands -novariables {core_1x32_no_fp_no_mmu__GC0}]

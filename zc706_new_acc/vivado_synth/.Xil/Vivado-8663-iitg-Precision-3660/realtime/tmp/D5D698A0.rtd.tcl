...
set genomeRtd $env(RT_TMP)/D5D698A0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {cpu_no_fp__GC0}]"
...
set genomeName [subst -nocommands -novariables {cpu_no_fp__GC0}]

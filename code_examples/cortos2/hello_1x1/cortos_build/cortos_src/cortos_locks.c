...
uint8_t* lockStartAddr   = 0x18000;
uint8_t* lockStartAddrNc = 0x19000; // non-cacheable
...
void cortos_init_locks() {
  ...
  uint8_t* lockStartAddr   = (uint8_t*)0x18000;
  uint8_t* lockStartAddrNc = (uint8_t*)0x19000; // non-cacheable

...
void main () 
{
	...
	int i;
	for (i=0;i<16;i++){
		write_to_accelerator_register (i, 0xffffffff);
	}
	//write_to_accelerator_register ('0', 0x00000003);
	//write_to_accelerator_register ('1', 0x40c00000);
	//write_to_accelerator_register (2, 0x3fc00000);	
	//write_to_accelerator_register (3, 0x00000001);

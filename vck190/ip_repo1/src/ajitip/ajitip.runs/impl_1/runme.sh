...
HD_PWD='/home/iitg/Desktop/AjitIITG/AjitIITG/1x1x32.iitg/vck190/ip_repo1/src/ajitip/ajitip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Ajit_vck190_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Ajit_vck190_wrapper.tcl -notrace

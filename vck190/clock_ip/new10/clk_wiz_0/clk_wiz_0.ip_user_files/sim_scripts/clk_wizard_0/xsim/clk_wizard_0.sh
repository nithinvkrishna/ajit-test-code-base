...
#
# Script generated by Vivado on Tue Aug 27 14:06:48 IST 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clk_wizard_0.sh
...
#
# Usage        : clk_wizard_0.sh
#                clk_wizard_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_wizard_0.sh [-reset_run]
#                clk_wizard_0.sh [-reset_log]
#                clk_wizard_0.sh [-help]
#
...
# script info
echo -e "clk_wizard_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_wizard_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wizard_0 xil_defaultlib.clk_wizard_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk_wizard_0 -key {Behavioral:sim_1:Functional:clk_wizard_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_wizard_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk_wizard_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk_wizard_0.sh [-help]\n\
Usage: clk_wizard_0.sh [-step]\n\
Usage: clk_wizard_0.sh [-lib_map_path]\n\
Usage: clk_wizard_0.sh [-reset_run]\n\
Usage: clk_wizard_0.sh [-reset_log]\n\
Usage: clk_wizard_0.sh [-keep_index]\n\
Usage: clk_wizard_0.sh [-noclean_files]\n\n\

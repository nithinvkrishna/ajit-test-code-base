...
HD_PWD='/home/iitg/Desktop/AjitIITG/AjitIITG/1x1x32.iitg/vck190/clock_ip/new10/clk_wiz_0/clk_wiz_0.runs/clk_wizard_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wizard_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wizard_0.tcl

...
module bd_70da
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME FPD_AXI_NOC_1, ADDR_WIDTH 64, ARUSER_WIDTH 18, AWUSER_WIDTH 18, BUSER_WIDTH 0, CATEGORY noc, CLK_DOMAIN bd_70da_pspmc_0_0_fpd_axi_noc_axi1_clk, DATA_WIDTH 128, FREQ_HZ 824991760, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 16, INDEX 1, INSERT_VIP 0, MAX_BURST_LENGTH 256, MY_CATEGORY ps_nci, NUM_READ_OUTSTANDING 64, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 64, NUM_WRITE_THREADS 1, PHASE 0.0, PHYSICAL_CHANNEL PS_NCI_TO_NOC_NMU, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 1, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) output [63:0]FPD_AXI_NOC_1_araddr;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 ARBURST" *) output [1:0]FPD_AXI_NOC_1_arburst;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 ARCACHE" *) output [3:0]FPD_AXI_NOC_1_arcache;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 ARID" *) output [15:0]FPD_AXI_NOC_1_arid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 ARLEN" *) output [7:0]FPD_AXI_NOC_1_arlen;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 ARLOCK" *) output FPD_AXI_NOC_1_arlock;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 ARPROT" *) output [2:0]FPD_AXI_NOC_1_arprot;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 ARQOS" *) output [3:0]FPD_AXI_NOC_1_arqos;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 ARREADY" *) input FPD_AXI_NOC_1_arready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 ARSIZE" *) output [2:0]FPD_AXI_NOC_1_arsize;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 ARUSER" *) output [17:0]FPD_AXI_NOC_1_aruser;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 ARVALID" *) output FPD_AXI_NOC_1_arvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 AWADDR" *) output [63:0]FPD_AXI_NOC_1_awaddr;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 AWBURST" *) output [1:0]FPD_AXI_NOC_1_awburst;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 AWCACHE" *) output [3:0]FPD_AXI_NOC_1_awcache;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 AWID" *) output [15:0]FPD_AXI_NOC_1_awid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 AWLEN" *) output [7:0]FPD_AXI_NOC_1_awlen;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 AWLOCK" *) output FPD_AXI_NOC_1_awlock;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 AWPROT" *) output [2:0]FPD_AXI_NOC_1_awprot;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 AWQOS" *) output [3:0]FPD_AXI_NOC_1_awqos;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 AWREADY" *) input FPD_AXI_NOC_1_awready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 AWSIZE" *) output [2:0]FPD_AXI_NOC_1_awsize;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 AWUSER" *) output [17:0]FPD_AXI_NOC_1_awuser;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 AWVALID" *) output FPD_AXI_NOC_1_awvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 BID" *) input [15:0]FPD_AXI_NOC_1_bid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 BREADY" *) output FPD_AXI_NOC_1_bready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 BRESP" *) input [1:0]FPD_AXI_NOC_1_bresp;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 BVALID" *) input FPD_AXI_NOC_1_bvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 RDATA" *) input [127:0]FPD_AXI_NOC_1_rdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 RID" *) input [15:0]FPD_AXI_NOC_1_rid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 RLAST" *) input FPD_AXI_NOC_1_rlast;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 RREADY" *) output FPD_AXI_NOC_1_rready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 RRESP" *) input [1:0]FPD_AXI_NOC_1_rresp;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 RVALID" *) input FPD_AXI_NOC_1_rvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 WDATA" *) output [127:0]FPD_AXI_NOC_1_wdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 WLAST" *) output FPD_AXI_NOC_1_wlast;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 WREADY" *) input FPD_AXI_NOC_1_wready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 WSTRB" *) output [15:0]FPD_AXI_NOC_1_wstrb;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 FPD_AXI_NOC_1 WVALID" *) output FPD_AXI_NOC_1_wvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 LPD_GPIO I" *) input [31:0]LPD_GPIO_i;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.FPD_AXI_NOC_AXI1_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.FPD_AXI_NOC_AXI1_CLK, ASSOCIATED_BUSIF FPD_AXI_NOC_1, CLK_DOMAIN bd_70da_pspmc_0_0_fpd_axi_noc_axi1_clk, FREQ_HZ 824991760, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0, PHYSICAL_CHANNEL PS_NCI_TO_NOC_NMU" *) output fpd_axi_noc_axi1_clk;
  ...
  (* HARD_CONN = "true" *) wire [63:0]pspmc_0_FPD_AXI_NOC_1_ARADDR;
  (* HARD_CONN = "true" *) wire [1:0]pspmc_0_FPD_AXI_NOC_1_ARBURST;
  (* HARD_CONN = "true" *) wire [3:0]pspmc_0_FPD_AXI_NOC_1_ARCACHE;
  (* HARD_CONN = "true" *) wire [15:0]pspmc_0_FPD_AXI_NOC_1_ARID;
  (* HARD_CONN = "true" *) wire [7:0]pspmc_0_FPD_AXI_NOC_1_ARLEN;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_ARLOCK;
  (* HARD_CONN = "true" *) wire [2:0]pspmc_0_FPD_AXI_NOC_1_ARPROT;
  (* HARD_CONN = "true" *) wire [3:0]pspmc_0_FPD_AXI_NOC_1_ARQOS;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_ARREADY;
  (* HARD_CONN = "true" *) wire [2:0]pspmc_0_FPD_AXI_NOC_1_ARSIZE;
  (* HARD_CONN = "true" *) wire [17:0]pspmc_0_FPD_AXI_NOC_1_ARUSER;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_ARVALID;
  (* HARD_CONN = "true" *) wire [63:0]pspmc_0_FPD_AXI_NOC_1_AWADDR;
  (* HARD_CONN = "true" *) wire [1:0]pspmc_0_FPD_AXI_NOC_1_AWBURST;
  (* HARD_CONN = "true" *) wire [3:0]pspmc_0_FPD_AXI_NOC_1_AWCACHE;
  (* HARD_CONN = "true" *) wire [15:0]pspmc_0_FPD_AXI_NOC_1_AWID;
  (* HARD_CONN = "true" *) wire [7:0]pspmc_0_FPD_AXI_NOC_1_AWLEN;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_AWLOCK;
  (* HARD_CONN = "true" *) wire [2:0]pspmc_0_FPD_AXI_NOC_1_AWPROT;
  (* HARD_CONN = "true" *) wire [3:0]pspmc_0_FPD_AXI_NOC_1_AWQOS;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_AWREADY;
  (* HARD_CONN = "true" *) wire [2:0]pspmc_0_FPD_AXI_NOC_1_AWSIZE;
  (* HARD_CONN = "true" *) wire [17:0]pspmc_0_FPD_AXI_NOC_1_AWUSER;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_AWVALID;
  (* HARD_CONN = "true" *) wire [15:0]pspmc_0_FPD_AXI_NOC_1_BID;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_BREADY;
  (* HARD_CONN = "true" *) wire [1:0]pspmc_0_FPD_AXI_NOC_1_BRESP;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_BVALID;
  (* HARD_CONN = "true" *) wire [127:0]pspmc_0_FPD_AXI_NOC_1_RDATA;
  (* HARD_CONN = "true" *) wire [15:0]pspmc_0_FPD_AXI_NOC_1_RID;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_RLAST;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_RREADY;
  (* HARD_CONN = "true" *) wire [1:0]pspmc_0_FPD_AXI_NOC_1_RRESP;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_RVALID;
  (* HARD_CONN = "true" *) wire [127:0]pspmc_0_FPD_AXI_NOC_1_WDATA;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_WLAST;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_WREADY;
  (* HARD_CONN = "true" *) wire [15:0]pspmc_0_FPD_AXI_NOC_1_WSTRB;
  (* HARD_CONN = "true" *) wire pspmc_0_FPD_AXI_NOC_1_WVALID;
  wire [31:0]pspmc_0_LPD_GPIO_I;
  wire [31:0]pspmc_0_LPD_GPIO_O;
  wire [31:0]pspmc_0_LPD_GPIO_T;
  ...
  (* HARD_CONN = "true" *) wire pspmc_0_fpd_axi_noc_axi1_clk;
  wire pspmc_0_pl0_ref_clk;
  (* HARD_CONN = "true" *) wire pspmc_0_pmc_axi_noc_axi0_clk;

  assign FPD_AXI_NOC_1_araddr[63:0] = pspmc_0_FPD_AXI_NOC_1_ARADDR;
  assign FPD_AXI_NOC_1_arburst[1:0] = pspmc_0_FPD_AXI_NOC_1_ARBURST;
  assign FPD_AXI_NOC_1_arcache[3:0] = pspmc_0_FPD_AXI_NOC_1_ARCACHE;
  assign FPD_AXI_NOC_1_arid[15:0] = pspmc_0_FPD_AXI_NOC_1_ARID;
  assign FPD_AXI_NOC_1_arlen[7:0] = pspmc_0_FPD_AXI_NOC_1_ARLEN;
  assign FPD_AXI_NOC_1_arlock = pspmc_0_FPD_AXI_NOC_1_ARLOCK;
  assign FPD_AXI_NOC_1_arprot[2:0] = pspmc_0_FPD_AXI_NOC_1_ARPROT;
  assign FPD_AXI_NOC_1_arqos[3:0] = pspmc_0_FPD_AXI_NOC_1_ARQOS;
  assign FPD_AXI_NOC_1_arsize[2:0] = pspmc_0_FPD_AXI_NOC_1_ARSIZE;
  assign FPD_AXI_NOC_1_aruser[17:0] = pspmc_0_FPD_AXI_NOC_1_ARUSER;
  assign FPD_AXI_NOC_1_arvalid = pspmc_0_FPD_AXI_NOC_1_ARVALID;
  assign FPD_AXI_NOC_1_awaddr[63:0] = pspmc_0_FPD_AXI_NOC_1_AWADDR;
  assign FPD_AXI_NOC_1_awburst[1:0] = pspmc_0_FPD_AXI_NOC_1_AWBURST;
  assign FPD_AXI_NOC_1_awcache[3:0] = pspmc_0_FPD_AXI_NOC_1_AWCACHE;
  assign FPD_AXI_NOC_1_awid[15:0] = pspmc_0_FPD_AXI_NOC_1_AWID;
  assign FPD_AXI_NOC_1_awlen[7:0] = pspmc_0_FPD_AXI_NOC_1_AWLEN;
  assign FPD_AXI_NOC_1_awlock = pspmc_0_FPD_AXI_NOC_1_AWLOCK;
  assign FPD_AXI_NOC_1_awprot[2:0] = pspmc_0_FPD_AXI_NOC_1_AWPROT;
  assign FPD_AXI_NOC_1_awqos[3:0] = pspmc_0_FPD_AXI_NOC_1_AWQOS;
  assign FPD_AXI_NOC_1_awsize[2:0] = pspmc_0_FPD_AXI_NOC_1_AWSIZE;
  assign FPD_AXI_NOC_1_awuser[17:0] = pspmc_0_FPD_AXI_NOC_1_AWUSER;
  assign FPD_AXI_NOC_1_awvalid = pspmc_0_FPD_AXI_NOC_1_AWVALID;
  assign FPD_AXI_NOC_1_bready = pspmc_0_FPD_AXI_NOC_1_BREADY;
  assign FPD_AXI_NOC_1_rready = pspmc_0_FPD_AXI_NOC_1_RREADY;
  assign FPD_AXI_NOC_1_wdata[127:0] = pspmc_0_FPD_AXI_NOC_1_WDATA;
  assign FPD_AXI_NOC_1_wlast = pspmc_0_FPD_AXI_NOC_1_WLAST;
  assign FPD_AXI_NOC_1_wstrb[15:0] = pspmc_0_FPD_AXI_NOC_1_WSTRB;
  assign FPD_AXI_NOC_1_wvalid = pspmc_0_FPD_AXI_NOC_1_WVALID;
  assign LPD_GPIO_o[31:0] = pspmc_0_LPD_GPIO_O;
  assign LPD_GPIO_t[31:0] = pspmc_0_LPD_GPIO_T;
  ...
  assign fpd_axi_noc_axi1_clk = pspmc_0_fpd_axi_noc_axi1_clk;
  assign pl0_ref_clk = pspmc_0_pl0_ref_clk;
  assign pmc_axi_noc_axi0_clk = pspmc_0_pmc_axi_noc_axi0_clk;
  assign pspmc_0_FPD_AXI_NOC_1_ARREADY = FPD_AXI_NOC_1_arready;
  assign pspmc_0_FPD_AXI_NOC_1_AWREADY = FPD_AXI_NOC_1_awready;
  assign pspmc_0_FPD_AXI_NOC_1_BID = FPD_AXI_NOC_1_bid[15:0];
  assign pspmc_0_FPD_AXI_NOC_1_BRESP = FPD_AXI_NOC_1_bresp[1:0];
  assign pspmc_0_FPD_AXI_NOC_1_BVALID = FPD_AXI_NOC_1_bvalid;
  assign pspmc_0_FPD_AXI_NOC_1_RDATA = FPD_AXI_NOC_1_rdata[127:0];
  assign pspmc_0_FPD_AXI_NOC_1_RID = FPD_AXI_NOC_1_rid[15:0];
  assign pspmc_0_FPD_AXI_NOC_1_RLAST = FPD_AXI_NOC_1_rlast;
  assign pspmc_0_FPD_AXI_NOC_1_RRESP = FPD_AXI_NOC_1_rresp[1:0];
  assign pspmc_0_FPD_AXI_NOC_1_RVALID = FPD_AXI_NOC_1_rvalid;
  assign pspmc_0_FPD_AXI_NOC_1_WREADY = FPD_AXI_NOC_1_wready;
  assign pspmc_0_LPD_GPIO_I = LPD_GPIO_i[31:0];
  ...
  bd_70da_pspmc_0_0 pspmc_0
       (.cpmps_corr_irq(1'b0),
        ...
        .fpd_axi_noc_axi1_araddr(pspmc_0_FPD_AXI_NOC_1_ARADDR),
        .fpd_axi_noc_axi1_arburst(pspmc_0_FPD_AXI_NOC_1_ARBURST),
        .fpd_axi_noc_axi1_arcache(pspmc_0_FPD_AXI_NOC_1_ARCACHE),
        .fpd_axi_noc_axi1_arid(pspmc_0_FPD_AXI_NOC_1_ARID),
        .fpd_axi_noc_axi1_arlen(pspmc_0_FPD_AXI_NOC_1_ARLEN),
        .fpd_axi_noc_axi1_arlock(pspmc_0_FPD_AXI_NOC_1_ARLOCK),
        .fpd_axi_noc_axi1_arprot(pspmc_0_FPD_AXI_NOC_1_ARPROT),
        .fpd_axi_noc_axi1_arqos(pspmc_0_FPD_AXI_NOC_1_ARQOS),
        .fpd_axi_noc_axi1_arready(pspmc_0_FPD_AXI_NOC_1_ARREADY),
        .fpd_axi_noc_axi1_arsize(pspmc_0_FPD_AXI_NOC_1_ARSIZE),
        .fpd_axi_noc_axi1_aruser(pspmc_0_FPD_AXI_NOC_1_ARUSER),
        .fpd_axi_noc_axi1_arvalid(pspmc_0_FPD_AXI_NOC_1_ARVALID),
        .fpd_axi_noc_axi1_awaddr(pspmc_0_FPD_AXI_NOC_1_AWADDR),
        .fpd_axi_noc_axi1_awburst(pspmc_0_FPD_AXI_NOC_1_AWBURST),
        .fpd_axi_noc_axi1_awcache(pspmc_0_FPD_AXI_NOC_1_AWCACHE),
        .fpd_axi_noc_axi1_awid(pspmc_0_FPD_AXI_NOC_1_AWID),
        .fpd_axi_noc_axi1_awlen(pspmc_0_FPD_AXI_NOC_1_AWLEN),
        .fpd_axi_noc_axi1_awlock(pspmc_0_FPD_AXI_NOC_1_AWLOCK),
        .fpd_axi_noc_axi1_awprot(pspmc_0_FPD_AXI_NOC_1_AWPROT),
        .fpd_axi_noc_axi1_awqos(pspmc_0_FPD_AXI_NOC_1_AWQOS),
        .fpd_axi_noc_axi1_awready(pspmc_0_FPD_AXI_NOC_1_AWREADY),
        .fpd_axi_noc_axi1_awsize(pspmc_0_FPD_AXI_NOC_1_AWSIZE),
        .fpd_axi_noc_axi1_awuser(pspmc_0_FPD_AXI_NOC_1_AWUSER),
        .fpd_axi_noc_axi1_awvalid(pspmc_0_FPD_AXI_NOC_1_AWVALID),
        .fpd_axi_noc_axi1_bid(pspmc_0_FPD_AXI_NOC_1_BID),
        .fpd_axi_noc_axi1_bready(pspmc_0_FPD_AXI_NOC_1_BREADY),
        .fpd_axi_noc_axi1_bresp(pspmc_0_FPD_AXI_NOC_1_BRESP),
        .fpd_axi_noc_axi1_bvalid(pspmc_0_FPD_AXI_NOC_1_BVALID),
        .fpd_axi_noc_axi1_clk(pspmc_0_fpd_axi_noc_axi1_clk),
        .fpd_axi_noc_axi1_rdata(pspmc_0_FPD_AXI_NOC_1_RDATA),
        .fpd_axi_noc_axi1_rid(pspmc_0_FPD_AXI_NOC_1_RID),
        .fpd_axi_noc_axi1_rlast(pspmc_0_FPD_AXI_NOC_1_RLAST),
        .fpd_axi_noc_axi1_rready(pspmc_0_FPD_AXI_NOC_1_RREADY),
        .fpd_axi_noc_axi1_rresp(pspmc_0_FPD_AXI_NOC_1_RRESP),
        .fpd_axi_noc_axi1_rvalid(pspmc_0_FPD_AXI_NOC_1_RVALID),
        .fpd_axi_noc_axi1_wdata(pspmc_0_FPD_AXI_NOC_1_WDATA),
        .fpd_axi_noc_axi1_wlast(pspmc_0_FPD_AXI_NOC_1_WLAST),
        .fpd_axi_noc_axi1_wready(pspmc_0_FPD_AXI_NOC_1_WREADY),
        .fpd_axi_noc_axi1_wstrb(pspmc_0_FPD_AXI_NOC_1_WSTRB),
        .fpd_axi_noc_axi1_wvalid(pspmc_0_FPD_AXI_NOC_1_WVALID),
        ...
        .lpd_gpio_i(pspmc_0_LPD_GPIO_I),
        .lpd_gpio_o(pspmc_0_LPD_GPIO_O),
        .lpd_gpio_t(pspmc_0_LPD_GPIO_T),

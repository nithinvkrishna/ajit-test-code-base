...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_29 -L axi_vip_v1_1_15 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_14 -L xlconstant_v1_1_8 -L lib_pkg_v1_0_3 -L axi_apb_bridge_v3_0_19 -L versal_cips_ps_vip_v1_0_7 -L cpm4_v1_0_14 -L cpm5_v1_0_14 -L axi_lite_ipif_v3_0_4 -L lib_srl_fifo_v1_0_3 -L axi_uartlite_v2_0_33 -L noc_nsu_v1_0_0 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_70da.protoinst" -protoinst "protoinst_files/bd_c482.protoinst" -protoinst "protoinst_files/bd_05d2.protoinst" -protoinst "protoinst_files/bd_4b24.protoinst" -protoinst "protoinst_files/bd_4bb4.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
